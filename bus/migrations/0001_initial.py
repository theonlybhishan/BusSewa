# Generated by Django 3.2.7 on 2022-09-11 02:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seat_type', models.CharField(choices=[('1*1', '1*1'), ('2*2', '2*2'), ('1*2', '1*2'), ('3*2', '3*2'), ('2*1', '2*1'), ('2*3', '2*3'), ('3*3', '3*3')], max_length=100)),
